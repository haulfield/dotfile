...
(function () {
    chrome.runtime.sendMessage({type : "getVkdSettings"}, function (response) {
        ...
        injectScript(chrome.extension.getURL('ga-config.js'), 'body');
        injectScript(chrome.extension.getURL('ga.js'), 'body');
        injectScript(chrome.extension.getURL('js15_as.js'), 'body');
