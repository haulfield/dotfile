...
// XXX bahaa: rm
var chrome = window.chrome, firefox = window.browser;
...
E.init = function(opt){
    ...
    opt = opt||{};
    var rpc = !chrome ? E.rpc_types.firefox_msg : use_msg ?
...
function chrome_have(){
    var have = {}, is_firefox = conf.firefox_web_ext;
    if (!conf.new_ui && !is_firefox)
